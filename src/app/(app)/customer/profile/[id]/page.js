...
// export default function Page() {
//   const { id } = useParams();
//   const [customerdata, setCustomerdata] = useState(null);bb     
//   const [openedit, setOpenedit] = useState(false);
//   const [appointments, setAppointments] = useState({
//     completed: [],
//     pending: [],
...
//       <div className="max-w-5xl mx-auto border border-gray-500/50 px-16 py-5   rounded-lg">
//         {/* Header */}
...
//             onClick={() => setOpenedit(true)}
//             type="button"
//             className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 hover:bg-blue-200 rounded-md text-sm text-blue-800"
//           >
//             <Edit size={14} />
//             Edit Profile
//           </button>
...
//               <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center overflow-hidden">
//                 <span className="text-lg font-medium text-white">
//                   {customerdata?.username
//                     ? customerdata.username.charAt(0).toUpperCase()
//                     : "U"}
...
//               <div className="bg-blue-100 px-4 py-2 rounded-md text-sm text-blue-800">
//                 Role:{" "}
//                 <span className="font-medium ml-2">
//                   {customerdata?.role ?? "—"}
//                 </span>
//               </div>
//               <div className="flex items-center gap-2 bg-green-100 px-4 py-2 rounded-md text-sm text-green-800">
//                 <Users size={16} />
//                 <span className="font-medium">
//                   {customerdata?.followers ?? 0}
//                 </span>
//                 <span>Followers</span>
//               </div>
//               <div className="flex items-center gap-2 bg-purple-100 px-4 py-2 rounded-md text-sm text-purple-800">
//                 <Users size={16} />
//                 <span className="font-medium">
//                   {customerdata?.following ?? 0}
//                 </span>
...
//                 <div className="space-y-1 max-h-44">
//                   {loadingAppointments ? (
//                     <div className="text-xs text-gray-500">
//                       Loading completed appointments...
//                     </div>
...
//               {/* Cancelled */}
//               <div className="bg-white rounded-md p-4 shadow-sm border border-gray-200 md:col-span-2">
//                 <div className="flex items-center justify-between mb-3">
//                   <div className="flex items-center gap-3">
//                     <XCircle size={18} className="text-red-500" />
//                     <div>
...
//           {/* Modal */}
//           <div className="relative bg-white rounded-2xl w-full max-w-lg p-8 z-10 shadow-2xl overflow-y-auto max-h-[90vh]">
//             {/* Header */}
//             <div className="flex justify-between items-center mb-6">
//               <div>
