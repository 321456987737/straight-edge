...
const RecentPendingAppointments = () => {
  ...
  const fetchAppointments = async (page) => {
    try {
      ...
      const res = await axios.get(
        `/api/barber/pendingappointment?skip=${skip}&limit=${pagination.limit}`
      );
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-6 text-center">📅 Recent pending Appointments</h2>
...
export default RecentPendingAppointments;
