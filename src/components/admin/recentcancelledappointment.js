...
const RecentCancelledAppointments = () => {
  ...
  const fetchAppointments = async (page) => {
    try {
      ...
      const res = await axios.get(
        `/api/barber/recentcancelledappointment?skip=${skip}&limit=${pagination.limit}`
      );
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4">
      <h2 className="text-2xl font-bold mb-6">📅 Recent Completed Appointments</h2>
...
export default RecentCancelledAppointments;
