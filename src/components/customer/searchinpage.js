...
export default function SearchInPage() {
  ...
  const renderBarberCard = (barber, index, array, isTopRated = false) => {
    ...
    return (
      <motion.div
        ...
        className="bg-white w-full rounded-lg  border justify-center border-black shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col "
      >
        {/* Image Section */}
  ...
  return (
    ...
    <div className="p-6 max-w-[1200px] mx-auto">
      <h1 className="md:text-3xl text-2xl  font-bold mb-6 text-gray-800">
